declare module PlayFabServerModule {
    export interface IPlayFabServer {
        ...
        LinkPSNId(
            request: PlayFabServerModels.LinkPSNIdRequest | null,
            callback: PlayFabModule.ApiCallback<PlayFabServerModels.LinkPSNIdResponse> | null,
        ): void;
...
declare module PlayFabServerModels {
    ...
    export interface LinkPSNIdRequest extends PlayFabModule.IPlayFabRequestCommon {
        // The optional custom tags associated with the request (e.g. build number, external trace identifiers, etc.).
        CustomTags?: { [key: string]: string | null };
        // If another user is already linked to the account, unlink the other user and re-link.
        ForceLink?: boolean;
    ...
    export interface LinkPSNIdResponse extends PlayFabModule.IPlayFabResultCommon {}
